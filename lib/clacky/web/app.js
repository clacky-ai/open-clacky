...
const Router = (() => {
  ...
  function _apply(view, params = {}) {
    ...
    // Reveal #main on first navigation — ensures the correct view is already
    // in place before the user sees anything (prevents welcome/onboard flash).
    const mainEl = document.getElementById("main");
    if (mainEl && mainEl.style.visibility === "hidden") mainEl.style.visibility = "";
