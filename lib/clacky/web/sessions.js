...
const Sessions = (() => {
  ...
  return {
    ...
    updateStatusBar(status) {
      ...
      // Send is always enabled — sending while running interrupts the agent
      // and queues the new message (agent.rb supports this natively).
      // The interrupt button is shown separately for explicit stop-only cases.
